...
export default function Navigation() {
  return (
    <nav className="p-5 bg-white shadow-md md:flex item-center justify-between max-h-[64px]  gap-7 rounded-[16px] relative max-w-7xl mx-auto">
      ...
      <ul className="ss sm:bg-white whitespace-nowrap sm:text-center sm:z-10 md:flex md:items-center z-[-1] md:z-auto md:static absolute md:bg-white md:text-black w-full left-0 md:w-auto md:py-0 md:pl-0 pl-7 md:opacity-100 opacity-0 top-[-400px] transition-all ease-in duration-500">
        ...
        <li className="mx-4 my-6 md:my-0">
          <a
            href="#"
            className="text-sm lg:text-lg hover:text-[#55BDB3] duration-500"
          >
            Home
          </a>
        </li>
        ...
        <li>
          <a
            href="#"
            className="text-sm lg:text-lg hover:text-[#55BDB3] duration-500 mr-4"
          >
            Why Choose Us
          </a>
        </li>
